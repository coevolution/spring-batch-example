...
public class InnerController extends BaseController {
     ...
     * @return
     */
    @RequestMapping("operations/start")
    public Long restartJob(@RequestParam String jobName, @RequestParam String jobParameterStr) {
     ...
     * @throws Exception
     */
    @RequestMapping("/operations/run/{job}")
    public Long handleJob(@PathVariable String job, HttpServletRequest request) throws Exception {
    ...
    @RequestMapping("/operation/stop/{job}")
    public Boolean stopJob(@PathVariable String job) {
